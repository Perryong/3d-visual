/**
 * Entry point. Owns the single piece of shared state — which part is
 * selected — and keeps the scene, the parts list and the callouts pointed at
 * the same answer.
 */
...
import { PARTS, SHEET } from '../data/bom.js';
...
const ui = createUI({ onSelect: select });
